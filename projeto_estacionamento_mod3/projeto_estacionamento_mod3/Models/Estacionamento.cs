...
namespace projeto_estacionamento_mod3.Models
{
    public class Estacionamento
    {
        ...
        int[] ArrayQuantidadeVagasTotais;
        ...
        {
            this.ArrayQuantidadeVagasTotais = new int[qtdeVagasDisponiveis];
        ...
        public void RetirarVeiculo()
        {
            ...
            foreach (Veiculo veiculoDaLista in ListaVeiculosEstacionados)
            {
                if (selecaoDeVeiculo == veiculoDaLista.Placa)
                {
                    ...
                    //Localiza o indice do objeto a ser removido na lista de estacionados.
                    indiceObjeto = ListaVeiculosEstacionados.IndexOf(veiculoDaLista);
                    break;
                }
            }
...

            {
                case true:
                    ...
                    //Removo o objeto veiculo da lista de estacionados de acordo com seu indice.
                    ListaVeiculosEstacionados.Remove(ListaVeiculosEstacionados[indiceObjeto]);
